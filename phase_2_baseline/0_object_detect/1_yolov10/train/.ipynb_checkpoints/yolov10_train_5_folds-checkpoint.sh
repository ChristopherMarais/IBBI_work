#!/bin/bash
#SBATCH --job-name=YOLOv10_5Fold
#SBATCH --output=./slurm_logs/YOLOv10_5fold_main_%j.out
#SBATCH --error=./slurm_logs/YOLOv10_5fold_main_%j.err
...
echo "Starting YOLOv10 5-Fold Training Script"
...
# IMPORTANT: Update this path if your yolov10_train_5_folds.py is elsewhere
SCRIPT_DIR="/blue/hulcr/gmarais/PhD/phase_2_baseline/0_object_detection/1_yolov10/train" # Assuming script is here
cd ${SCRIPT_DIR}
echo "Changed directory to: $(pwd)"

# Run the Python file
# Ensure the script is named yolov10_train_5_folds.py or update the name here
echo "Running Python script: yolov10_train_5_folds.py"
python yolov10_train_5_folds.py
