#!/bin/bash
#SBATCH --job-name=rfdetr_5Fold
#SBATCH --output=./slurm_logs/rfdetr_5fold_main_%j.out
...
echo "Starting rfdetr 5-Fold Training Script"
...
# IMPORTANT: Update this path if your rfdetr_train_5_folds.py is elsewhere
SCRIPT_DIR="/blue/hulcr/gmarais/PhD/IBBI_work/phase_2_baseline/0_object_detect/3_rfdetr/train" # Assuming script is here
cd ${SCRIPT_DIR}
echo "Changed directory to: $(pwd)"

# Run the Python file
# Ensure the script is named rfdetr_train_5_folds.py or update the name here
echo "Running Python script: rfdetr_5fold.py"
python rfdetr_5fold.py
