#!/bin/bash
#SBATCH --job-name=dinov2_5Fold
#SBATCH --output=./slurm_logs/dinov2_5fold_main_%j.out
#SBATCH --error=./slurm_logs/dinov2_5fold_main_%j.err
...
echo "Starting dinov2 5-Fold Training Script"
...
# IMPORTANT: Update this path if your dinov2_train_5_folds.py is elsewhere
SCRIPT_DIR="/blue/hulcr/gmarais/PhD/IBBI_work/phase_2_baseline/0_object_detect/4_dinov2/train/mmdetection/" # Assuming script is here
cd ${SCRIPT_DIR}
echo "Changed directory to: $(pwd)"

# Run the Python file
# Ensure the script is named dinov2_train_5_folds.py or update the name here
echo "Running Python script: dinov2_5fold.py"
python dinov2_5fold.py
