#!/bin/bash
#SBATCH --job-name=YOLOv11_5Fold
#SBATCH --output=./slurm_logs/YOLOv11_5fold_main_%j.out
#SBATCH --error=./slurm_logs/YOLOv11_5fold_main_%j.err
...
echo "Starting YOLOv11 5-Fold Training Script"
...
# IMPORTANT: Replace 'YOLO11' with the actual name of your conda environment if different
...
# IMPORTANT: Update this path if your yolov11_train_5_folds.py is elsewhere
SCRIPT_DIR="/blue/hulcr/gmarais/PhD/phase_2_baseline/0_object_detection/6_yolov11/train" # Assuming script is here
cd ${SCRIPT_DIR}
echo "Changed directory to: $(pwd)"

# Run the Python file
# Ensure the script is named yolov11_train_5_folds.py or update the name here
echo "Running Python script: yolov11_5fold.py"
python yolov11_5fold.py
