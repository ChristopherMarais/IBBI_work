#!/bin/bash
#SBATCH --job-name=YOLOv9_5Fold
#SBATCH --output=./slurm_logs/YOLOv9_5fold_main_%j.out
#SBATCH --error=./slurm_logs/YOLOv9_5fold_main_%j.err
...
#SBATCH --mem=256G                 # Total memory for the job (shared by all 5 python processes)
...
echo "Starting YOLOv9 5-Fold Training Script"
...
# IMPORTANT: Replace 'YOLO9' with the actual name of your conda environment if different
...
# IMPORTANT: Update this path if your yolov9_train_5_folds.py is elsewhere
SCRIPT_DIR="/blue/hulcr/gmarais/PhD/phase_2_baseline/0_object_detection/7_yolov9/train" # Assuming script is here
cd ${SCRIPT_DIR}
echo "Changed directory to: $(pwd)"

# Run the Python file
# Ensure the script is named yolov9_train_5_folds.py or update the name here
echo "Running Python script: yolov9_5fold.py"
python yolov9_5fold.py
