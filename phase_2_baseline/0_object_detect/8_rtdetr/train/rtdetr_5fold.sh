#!/bin/bash
#SBATCH --job-name=rtdetr_5Fold
#SBATCH --output=./slurm_logs/rtdetr_5fold_main_%j.out
#SBATCH --error=./slurm_logs/rtdetr_5fold_main_%j.err
...
echo "Starting rtdetr 5-Fold Training Script"
...
SCRIPT_DIR="/blue/hulcr/gmarais/PhD/phase_2_baseline/0_object_detection/8_rtdetr/train" # Assuming script is here
cd ${SCRIPT_DIR}
echo "Changed directory to: $(pwd)"

# Run the Python file
# Ensure the script is named rtdetr_train_5_folds.py or update the name here
echo "Running Python script: rtdetr_5fold.py"
python rtdetr_5fold.py
